...
const Navbar1 = () => {
  return (
    <ul className="nav-links md:hidden fixed  bottom-5 left-14 flex gap-5 px-5 py-2 rounded-full border border-white/30 backdrop-blur-xl bg-white/10 max-w-screen-sm">
